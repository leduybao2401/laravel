 <!-- Add Modal -->
 <div wire:ignore.seft class="modal fade" id="addBrandModal" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
             ...
             <form wire:submit.prevent="storeBrand">
                 <div class="modal-body  bg-contents">
                     <div class="mb-3">
                         ...
                         <select wire:model.defer="category_id" required class="form-control p-3">
                     ...
                     <div class="mb-3">
                         <label class="mb-3">Brand Name</label>
 ...
 <!-- Update Modal -->
 <div wire:ignore.seft class="modal fade" id="updateBrandModal" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
     <div class="modal-dialog">
         <div class="modal-content">
             <div class="modal-header">
 ...
 <!-- Delete Modal -->
 <div wire:ignore.seft class="modal fade" id="deleteBrandModal" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
     <div class="modal-dialog">
         <div class="modal-content">
             <div class="modal-header">
